...
func RegisterHandlers(server *rest.Server, svcCtx *svc.ServiceContext) {
	...
	server.AddRoutes([]rest.Route{
		...
		{Method: http.MethodGet, Path: "/users/:id/devices", Handler: adminUserDevicesHandler(svcCtx)},
		{Method: http.MethodPost, Path: "/users/:id/devices/kick", Handler: adminKickDeviceHandler(svcCtx)},
